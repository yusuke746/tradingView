...
ENTRY_FILTER_PROMPT_PREFIX: str = (
    ...
    "- Do NOT collapse valid entries to one repeated score (e.g., always 78). Use score spread to reflect quality differences.\n"
    "- If window_counts.opposed >= 2: normally cap score at 74 unless EV is strong (atr_to_spread >= 18) and structure is clearly supportive.\n"
    "- If aligned=1 and opposed=1 with acceptable EV: prefer 75-79 range, not 80+ by default.\n"
    "- If aligned>=2, opposed=0, and atr_to_spread>=16 with clean structure: prefer 80-86 range.\n"
    "- Reserve 87+ for rare, clearly superior setups only.\n\n"
