...
ENTRY_FILTER_PROMPT_PREFIX: str = (
    ...
    "  B   = Extended Sweep (×5.0 TTL) + Zone only. Reduced-conviction setup — LRR executes at 50% lot automatically; AI scoring still applies normally.\n"
    "  REJECT = blocked before reaching AI. Never seen by this prompt.\n"
    "Treat A+ as strongest, A as standard, B as frequency-extension opportunity (lower conviction, already lot-discounted by LRR).\n"
    ...
    "  If setup_path is 'B' or 'LR_RETRIG': multiply ALL freshness penalties above by 1.5.\n"
